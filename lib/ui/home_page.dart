                ...
                children: [
                  Container(
                    ...
                    height: 250.0,
                      child:Card(
                        child:
                        (post.posts[index].image == null) ? Image.network('https://yt3.ggpht.com/a/AATXAJzP8iiqrbsEgxZHXXZynrPyJGPVbD3o4xIbov9tchg=s900-c-k-c0xffffffff-no-rj-mo'
                        ): Image.network(
                          "http://foodreview.khaingthinkyi.me/" + post.posts[index].image,
                          fit: BoxFit.cover,
                        ),
                      )
                    ),
